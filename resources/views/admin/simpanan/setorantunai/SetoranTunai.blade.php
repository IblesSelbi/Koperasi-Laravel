                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="namaPenyetor"
...
@push('scripts')
    <script>
        ...
        $(document).ready(function () {
            ...
            // Handle Anggota Selection - Show Photo & Dept (UPDATED)
            // Handle Anggota Selection - Show Photo & Dept (UPDATED)
            $('#anggotaId').on('change', function () {
                const anggotaId = $(this).val();

                if (anggotaId) {
                    // ✅ URL YANG BENAR: /admin/setoran/anggota-detail/
                    fetch(`/admin/setoran/anggota-detail/${anggotaId}`)
                        .then(res => {
                            if (!res.ok) {
        ...
        function cetakLaporan() {
            ...
            let url = '{{ route("simpanan.setoran.cetak-laporan") }}';
