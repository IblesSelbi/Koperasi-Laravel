        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted fs-3 mb-0">Kelola transaksi penarikan simpanan anggota</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="tabelPenarikan" class="table table-hover align-middle rounded-2 border overflow-hidden"
                    ...
                    <tbody>
                        @foreach($penarikan as $index => $item)
                            <tr data-id="{{ $item->id }}">
                    ...
                    <tfoot>
                        <tr class="table-light">
                            ...
                            <th class="text-end fw-semibold text-danger fs-4">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <h6 class="fw-semibold mb-3 text-primary">Identitas Penarik (Opsional)</h6>
                                ...
                                <h6 class="fw-semibold mb-3 text-primary">Data Penarikan</h6>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="dariKasId" required>
                                        <option value="">-- Pilih Kas --</option>
                                        @foreach($kas_list as $kas)
                                            <option value="{{ $kas->id }}">{{ $kas->nama_kas }}</option>
                                        @endforeach
                                    </select>
                                    <small class="text-muted">Hanya kas yang aktif dan bisa penarikan</small>
                                </div>
