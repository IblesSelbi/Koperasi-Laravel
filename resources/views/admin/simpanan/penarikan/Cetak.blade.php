...
<body>
                    ...
                    <div class="info-line">
                        <table>
                            <tr>
                                ...
                                <td class="value">:
                                    {{ \Carbon\Carbon::parse($penarikan->tanggal_transaksi)->format('d F Y / H:i') }}
                                </td>
                            </tr>
                        </table>
                    </div>
                    <div class="info-line">
                        <table>
                            <tr>
                                ...
                                <td class="value">: {{ $penarikan->kode_transaksi }}</td>
                            </tr>
                        </table>
                    </div>
                    <div class="info-line">
                        <table>
                            <tr>
                                ...
                                <td class="value">: {{ $penarikan->anggota->id_anggota ?? '-' }}</td>
                            </tr>
                        </table>
                    </div>
                    <div class="info-line">
                        <table>
                            <tr>
                                ...
                                <td class="value">: {{ $penarikan->anggota->nama ?? '-' }}</td>
                            </tr>
                        </table>
                    </div>
                    <div class="info-line">
                        <table>
                            <tr>
                                ...
                                <td class="value">: {{ $penarikan->anggota->departement ?? '-' }}</td>
                            </tr>
                        </table>
                    </div>
                    @if($penarikan->nama_penarik)
                        <div class="info-line">
                            <table>
                                <tr>
                                    <td class="label">Nama Penarik</td>
                                    <td class="value">: {{ $penarikan->nama_penarik }}</td>
                                </tr>
                            </table>
                        </div>
                    @endif
                        ...
                        <div class="info-line">
                            <table>
                                <tr>
                                    ...
                                    <td class="value">: {{ $penarikan->alamat }}</td>
                                </tr>
                            </table>
                        </div>
                    @endif
                    ...
                    <div class="info-line">
                        <table>
                            <tr>
                                ...
                                <td class="value">: {{ $penarikan->user->name ?? 'admin' }}</td>
                            </tr>
                        </table>
                    </div>
                    <div class="info-line">
                    ...
                    <div class="info-line">
                        <table>
                            <tr>
                                ...
                                <td class="value">: {{ $penarikan->jenisSimpanan->jenis_simpanan ?? '-' }}</td>
                            </tr>
                        </table>
                    </div>
                    <div class="info-line">
                        <table>
                            <tr>
                                ...
                                <td class="value">: {{ $penarikan->dariKas->nama_kas ?? '-' }}</td>
                            </tr>
                        </table>
                    </div>
                </td>
    ...
    <div class="amount-box">
        ...
        <div class="amount-value">Rp. {{ number_format($penarikan->jumlah, 0, ',', '.') }}</div>
    ...
    <div class="signature-area">
        <table>
            <tr>
                <td class="sig-box">
                    <div class="sig-title">Penarik,</div>
                    <div class="sig-line">
                        {{ $penarikan->nama_penarik ?? $penarikan->anggota->nama ?? '_______________' }}
                    </div>
                </td>
