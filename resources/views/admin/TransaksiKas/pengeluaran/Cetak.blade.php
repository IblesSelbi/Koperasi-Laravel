...
<head>
    ...
    <title>Laporan Data Pengeluaran Kas</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <!-- Title -->
    <div class="title">
        <h1>Laporan Data Pengeluaran Kas</h1>
        <p>{{ $periode }}</p>
    </div>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th>Uraian</th>
                <th width="120">Dari Kas</th>
                <th width="120">Untuk Akun</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $item->uraian }}</td>
                <td>{{ $item->dariKas->nama_kas ?? '-' }}</td>
                <td>{{ $item->untukAkun->nama_akun ?? '-' }}</td>
        ...
        <tfoot>
            <tr>
                ...
                <td class="right">{{ number_format($total_pengeluaran, 0, ',', '.') }}</td>
                <td></td>
            </tr>
        </tfoot>
    </table>
