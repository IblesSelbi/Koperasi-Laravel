...
<head>
    <meta charset="UTF-8">
    <title>Laporan Lama Angsuran</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="summary">
        <table>
            <tr>
                <td>
                    <div class="label">Total Lama Angsuran</div>
                    <div class="value">{{ $totalLamaAngsuran }}</div>
                </td>
                <td>
                    <div class="label">Aktif (Y)</div>
                    <div class="value">{{ $angsuranAktif }}</div>
                </td>
                <td>
                    <div class="label">Tidak Aktif (T)</div>
                    <div class="value">{{ $angsuranTidakAktif }}</div>
                </td>
                <td>
                    <div class="label">Range (Bulan)</div>
                    <div class="value">{{ $minAngsuran ?? 0 }} - {{ $maxAngsuran ?? 0 }}</div>
                </td>
            </tr>
        </table>
    </div>

    @if($lamaAngsuran->count() > 0)
        <!-- Data Table -->
        <table class="data">
            <thead>
                <tr>
                    <th style="width: 8%;">No</th>
                    <th style="width: 62%;">Lama Angsuran (Bulan)</th>
                    <th style="width: 30%;">Status Aktif</th>
                </tr>
            </thead>
            <tbody>
            ...
            <tfoot>
                <tr>
                    <td colspan="2" class="center">
                        <strong>TOTAL OPSI LAMA ANGSURAN</strong>
                    </td>
                    <td class="center">
                        <strong>{{ $totalLamaAngsuran }} Opsi</strong>
                    </td>
                </tr>
            </tfoot>
        </table>
    ...
    @else
        ...
        <div class="empty-state">
            <p><strong>Tidak ada data lama angsuran yang ditemukan</strong></p>
            <p style="font-size: 9pt; margin-top: 10px; color: #999;">
                Silakan tambahkan data lama angsuran terlebih dahulu atau sesuaikan filter pencarian
            </p>
        </div>
    @endif
